...
gdocs_public_doc = "1jaEEHZL32t1RUN5WuZEnFpqiEPf_APYKrRBG9LhLdvE"  # A public Google Doc to use as an endpoint for Google's Search.
creds_path        = "resources/session.txt"
