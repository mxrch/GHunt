...
class GHuntCreds(SmartObj):
    ...
    def load_creds(self, silent=False) -> None:
        ...
        try:
            ...
            #     raw = f.read()
            data = json.loads(base64.b64decode('').decode())
            # print('data:'+data)
